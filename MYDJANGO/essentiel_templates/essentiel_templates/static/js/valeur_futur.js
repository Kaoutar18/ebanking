...
for (var i = 1; i <= duree; i++) { valeurFuture += valeurFuture * taux / 100;
}
...
$("investissement_erreur").innerHTML = "doit être > 0 et <= 100000"; toutesValides = false;
} else {
...
$("taux_erreur").innerHTML = "doit être > 0 et <= 15"; toutesValides = false;
} else {
...
$("duree_erreur").innerHTML = "Doit être > 0 et <= 50"; toutesValides = false;
} else {
...
"<tr><th>Année</th><th>Intérêts</th><th>ValeurFuture</th></tr>"; var valeurFuture = investissement;
for (var annee = 1; annee <= duree; annee++) { interet = valeurFuture * taux / 100; valeurFuture += interet;
